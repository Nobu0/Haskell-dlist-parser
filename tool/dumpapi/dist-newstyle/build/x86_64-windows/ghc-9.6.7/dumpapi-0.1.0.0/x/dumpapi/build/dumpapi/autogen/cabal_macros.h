...
/* package dumpapi-0.1.0.0 */
#ifndef VERSION_dumpapi
#define VERSION_dumpapi "0.1.0.0"
#endif /* VERSION_dumpapi */
#ifndef MIN_VERSION_dumpapi
#define MIN_VERSION_dumpapi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_dumpapi */
...
#define CURRENT_COMPONENT_ID "dumpapi-0.1.0.0-inplace-dumpapi"
